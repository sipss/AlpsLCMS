...
#' Method for lcms_data_analysis (PLSDA model with AUROC and VIP outputs)
...
#'
#' @return Returns an object to be used with [lcms_data_analysis] to perform a (optionally
...
#'
#' @param ... Results of [lcms_data_analysis] to be combined. Give each result a name.
#'
