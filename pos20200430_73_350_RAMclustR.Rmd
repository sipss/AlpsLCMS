...
```{r}
concentrated_S <- filterFile(dataset_pos_73_350, 
                             file = c("Plasma6.mzXML",
                                      "Plasma18.mzXML",
                                      "Plasma10.mzXML"))
concentrated_L <- filterFile(dataset_pos_350_900, 
                             file = c("Plasma6.mzXML",
                                      "Plasma18.mzXML",
                                      "Plasma10.mzXML"))
...
```{r Base peak}
base_peaks_beforeS <- xcms::chromatogram(peakdet_pos_73_350,
                                        aggregationFun = "max")

base_peaks_afterS <-  xcms::chromatogram(peakgrouped_pos_73_350,
                                       aggregationFun = "max")

base_peaks_beforeL <- xcms::chromatogram(peakdet_pos_350_900,
                                        aggregationFun = "max")

base_peaks_afterL <-  xcms::chromatogram(peakgrouped_pos_350_900,
                                       aggregationFun = "max")
```
