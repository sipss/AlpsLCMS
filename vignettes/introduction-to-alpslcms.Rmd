...
```{r}
# peakpeaking_par <- default_peakpicking_params(optimize = optimize)
# resultPeakpicking <- peakpicking_optimization(dataset = subset,
#                                               peakpickingParameters = peakpeaking_par,
#                                               nSlaves = nSlaves,
#                                               opt_path = NULL,
#                                               plots = FALSE)
```
...
peakdet <- xcms::findChromPeaks(dataset, param = optimizedXcmsSetObject)
```
